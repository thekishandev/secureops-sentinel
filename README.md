...
- [Learning Journey](demo/learning-journey.md) — What we learned building this
- [Risk Matrix](demo/risk-matrix.md) — Risks and mitigations
- [Demo Script](demo/demo-script.md) — 3-minute demo narration
- [Slide Deck](demo/slides.md) — 7-slide pitch deck
- [Q&A Prep](demo/qa-prep.md) — Judge questions & answers

---

## 📄 Related Docs

- [CONTEXT.md](../CONTEXT.md) — Project identity and constraints
- [ARCHITECTURE.md](../ARCHITECTURE.md) — System design and data flows
- [PRD.md](../PRD.md) — Product requirements
- [IMPLEMENTATION.md](../IMPLEMENTATION.md) — Sprint-by-sprint build guide
